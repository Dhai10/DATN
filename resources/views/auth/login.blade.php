        ...
        <div class="row g-0">
            <div class="col-lg-6">
                <div class="login-left">
                    ...
                    <p>Chào mừng bạn quay lại! Hệ thống quản lý sân bóng hiện đại, giúp bạn dễ dàng quản lý và đặt sân một cách nhanh chóng.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="login-right">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="link-text" href="{{ route('password.request') }}">Quên mật khẩu?</a>
                            @endif
                        </div>
                    ...
                    <div class="text-center">
                        <p class="mb-0">Chưa có tài khoản? <a href="{{ route('register') }}" class="link-text">Đăng Ký Ngay</a></p>
                    </div>
                </div>
            </div>
        </div>
